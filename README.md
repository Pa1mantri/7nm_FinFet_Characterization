...
| Sr.No | W PMOS | L PMOS | (W/L)PMOS | W NMOS | L NMOS | (W/L)NMOS | Vt(V)  | Id     | Power Consumption | Prop. delay t_pd (PS)   |  Gain(Av) | Noise Margin NMH,NML | gm  | Freq (GHz)    | Output(r0) |
| :---: | :----: | :----: | :-------: | :----: | :----: | :-------: | :---:  | :---:  | :---------------: | :---------------------: | :-------: | :------------------: | :-: | :-----------: | :--------: | 
...
**** Adding resistor in bias network
**R3 net1 net2 539    
**** Adding a resistor in the startup circuit 
*** R3 net6 GND 539
